...
public class PicBucketDemo {
    ...
    // 运行前先设置好以下三个参数
    private static final String BUCKET_NAME = "ivansun123";
    private static final String OPERATOR_NAME = "test";
    private static final String OPERATOR_PWD = "sun901010";
    ...
    /** 根目录 */
    private static final String DIR_ROOT = "/chaz/pic";

    /** 上传到upyun的图片名 */
    private static final String PIC_NAME = "52.pic_hd.jpg";

    /** 本地待上传的测试文件 */
    private static final String SAMPLE_PIC_FILE ="/Users/ivan/Pictures/52.pic_hd.jpg";
